...
while True:
    try:
        ...
        if message.startswith("nlp:"):
            ...
            prompt = f"{context} Convert this to a shell command.Exclude venv,node_module,.git_directories Examples: 'show python files' -> 'find . -name \"*.py\"', 'count lines in file' -> 'wc -l filename'. Return ONLY the command: {query}"  
