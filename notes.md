...
| Named pipes (FIFO)    | C ↔ Python communication |
| mkfifo                | creating FIFOs |
| O_NONBLOCK            | non-blocking file open |
| Python requests       | ollama HTTP API |
| fork + execvp         | launching Python daemon |
| last_exit_status      | tracking command exit codes |
| WEXITSTATUS           | extracting exit codes |
